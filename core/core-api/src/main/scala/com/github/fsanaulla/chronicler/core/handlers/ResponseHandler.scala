...
private[chronicler] trait ResponseHandler[M[_], R] {
  ...
  /**
    ...
    */
  private[chronicler] def toResult(response: R): M[WriteResult]
  ...
  /**
    ...
    */
  private[chronicler] def toQueryJsResult(response: R): M[QueryResult[JArray]]
  ...
  /**
    ...
    */
  private[chronicler] def toGroupedJsResult(response: R): M[GroupedResult[JArray]]
  ...
  /**
    ...
    */
  private[chronicler] def toBulkQueryJsResult(response: R): M[QueryResult[Array[JArray]]]
  ...
  /**
    ...
    */
  private[chronicler] def toQueryResult[A: ClassTag](response: R)(implicit reader: InfluxReader[A]): M[QueryResult[A]]
  ...
  /***
    ...
    */
  private[chronicler] def errorHandler(response: R, code: Int): M[InfluxException]
  ...
  /***
    ...
    * @return - CQ results
    */
  private[chronicler] final def toCqQueryResult(response: R)(implicit reader: InfluxReader[ContinuousQuery]): M[QueryResult[ContinuousQueryInfo]] = {
  ...
  /***
    ...
    */
  private[chronicler] final def toShardQueryResult(response: R)(implicit reader: InfluxReader[Shard]): M[QueryResult[ShardInfo]] = {
  ...
  /***
    ...
    */
  private[chronicler] final def toSubscriptionQueryResult(response: R)(implicit reader: InfluxReader[Subscription]): M[QueryResult[SubscriptionInfo]] = {
  ...
  /***
    ...
    */
  private[chronicler] final def toShardGroupQueryResult(response: R)(implicit reader: InfluxReader[ShardGroup]): M[QueryResult[ShardGroupsInfo]] = {
