...
private[fsanaulla] trait AsyncRequestHandler
  extends RequestHandler[Response[String], Uri, Method, String] {
  ...
  override protected def readRequest(uri: Uri, method: Method, entity: Option[String]): Future[Response[JsObject]] = {
    method match {
